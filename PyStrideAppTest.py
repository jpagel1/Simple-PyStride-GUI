...
class Window:
    ...
    def updateIO(self):
        ...
        #Read In Inputs
            ...
            #Previous Values
            self.previousDI0 = digIn[0]
            self.previousDI1 = digIn[1]
            self.previousDI2 = digIn[2]
            self.previousDI3 = digIn[3]
        ...
        self.root.after(50, self.updateIO)
    ...
    def createGUI(self, message):
        ...
        self.testStride = 0
        self.previousDI0 = False
        self.previousDI1 = False
        self.previousDI2 = False
        self.previousDI3 = False
